...
function banner($Green,$White){
	echo "$Green    ___  ____  _____  ____  ____  ____  _  _ 
   / __)(  _ \(  _  )(_  _)(_  _)( ___)( \/ )
   \__ \ )___/ )(_)(   )(   _)(_  )__)  \  / 
   (___/(__)  (_____) (__) (____)(__)   (__) \n" . "$White       Rec0ded by https://github.com/dzgif\n\n";
}
...
function generateAccount($Red,$White,$Green,$Grey,$Blue){
	...
	echo "\n\n ϟ Done Create Spotify Account by DZ\n\n$Grey Donasi $White($Blue DANA $White) : 082150823303\n\n";
}
